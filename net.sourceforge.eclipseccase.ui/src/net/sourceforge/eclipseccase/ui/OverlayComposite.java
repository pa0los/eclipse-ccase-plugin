...
public class OverlayComposite extends CompositeImageDescriptor {
	...
	/**
	 * Add the passed image to this descriptor's collection of images to be
	 * composed together to create an image.
	 */
	...
	public boolean equals(Object o) {
		...
		return equals(backgroundImage, other.backgroundImage) && equals(leftImage, other.leftImage) && equals(rightImage, other.rightImage) && equals(topImage, other.topImage) && equals(bottomImage, other.bottomImage) && equals(foregroundImages, other.foregroundImages);
	}
	...
	/**
	 * Answer self's size, as determined by the size of the initially- provided
	 * base-level image
	 */
	@Override
	...
	@Override
	public int hashCode() {
		return hashCode(backgroundImage) + hashCode(leftImage) + hashCode(rightImage) + hashCode(topImage) + hashCode(bottomImage) + hashCode(foregroundImages);
	}

	/**
	 * Private utility for getting the hashCode for an object that may be null.
	 */
